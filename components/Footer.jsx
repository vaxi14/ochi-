...
function Footer() {
  return (
    <div className='w-full h-screen bg-[#F1F1F1] flex p-10 leading-none tracking-tighter '>
      <div className='w-1/2 h-screen flex flex-col justify-between p-10   font-["Founders_Grotesk_X-Condensed"] text-8xl font-bold '>
      ...
      <div className='w-1/2 '>
        <h1 className='font-["Founders_Grotesk_X-Condensed"] text-8xl leading-none tracking-tighter font-bold'>PRESENTATIONS</h1>
        <div className='details font-["Neue_Montreal"] mt-10 '>
            <a className='block text-xl font-light' href="#">Fcebook</a>
